 ...
 * @author ismaf
 */
public class Problem001ParallelNGTest {
    ...
    public Problem001ParallelNGTest() {
    }
    ...
    public void testRun() {
        ...
        long step = Runtime.getRuntime().availableProcessors() % 2 == 0 ? 2 : 1; 
        for (long numberOfThreads = 0; numberOfThreads < Runtime.getRuntime().availableProcessors(); numberOfThreads += step) {
